                    ...
                    <div className="flex flex-col h-full justify-between">
                        ...
                        <div className="flex flex-wrap gap-4">
                            ...
                            <div className="flex items-center gap-2 ml-2">
                                <Link href="https://www.linkedin.com/in/ariff-azahari-894985165/" target="_blank" className="p-2.5 bg-white/5 rounded-full hover:bg-[#0077b5] hover:text-white transition-all text-gray-400">
                                    <FaLinkedin size={20} />
                                </Link>
                                <Link href="https://github.com/Ariff007" target="_blank" className="p-2.5 bg-white/5 rounded-full hover:bg-[#333] hover:text-white transition-all text-gray-400">
                                    <FaGithub size={20} />
                                </Link>
                            </div>
                        </div>
